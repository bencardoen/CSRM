...
%This measure records the convergence more accurately as the fittest expressions drive the convergence rate. 
...
%LW: the scale is not relevant is you present a ratio. It is used for both measures...
