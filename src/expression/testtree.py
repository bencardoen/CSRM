...
class TreeTest(unittest.TestCase):
    ...
    def testPrintUseCase(self):
        expr = " ( ( ( x2 + 0.2692330739385492 ) ** ( ( ( abs( ( min( x2, 0.9046716652767782 ) ) ) ) * ( ln( x1 ) ) ) / ( ( ln( ( 0.27443469320601277 / x0 ) ) ) % ( max( 0.8898870280466706, ( max( x0, 0.27443469320601277 ) ) ) ) ) ) ) + ( ( ( cos( x2 ) ) + 0.3300462001408116 ) ** ( 0.9622203072129067 / ( ( 0.1981909265942815 ** ( x1 / 0.8887529604265793 ) ) * 1.0268937727179728 ) ) ) )"
        dcount = 2
        vcount = 5
        variables = generateVariables(vcount, dcount, 0)
        t = Tree.createTreeFromExpression(expr, variables=variables)
